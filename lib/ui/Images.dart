...
FileType _pickType2=FileType.any;
...
Future getImageFromGallery() async {
    ...
    var image = await ImagePicker().getImage(source: ImageSource.gallery , imageQuality: imageQuality);
...
//showAppLoading(_context);
    try {
      ...
      error = e.toString();
      print("Error Ya man 1");
      print("Error Ya man 2");
      print(e.toString());
    ...
    on Exception catch (e) {
      error = e.toString();
      print("Error Ya man 3");
      print("Error Ya man 4");
      print(e.toString());
      //throw(e.toString());
      return ;
    }
    catch(Excep){
      print("Error Ya man 5");
      print("Error Ya man 6");
      //throw(Excep.to);
      return ;
    }
...
void openFileExplorer2() async {
    try {
      ...
      if (_multiPick) {
        var value = await FilePicker.platform.pickFiles();
        _paths2 = {value.files.first.name : value.files.first.path};
        _paths2.forEach((fileName, filePath) => {upload2(fileName, filePath)});   
        print("Length");
        if(_paths2==null){
          print("Null Ya Prince");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: new Text(AppLocalizations.of(context).lblImages,  style: MansaFont.baseFontStyle() ,) ,
          centerTitle: true,
                    ...
                    Row(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            ...
                            child: Container(
                            child: Image.asset(
                               AppLocalizations.of(context).locale=="en" ?'images/uploadSctipt.PNG':'images/uploadSctiptAr.PNG',
                              height: 30,
                              width: 250,
                              fit: BoxFit.fill,
                              alignment: Alignment.center,
...
send_data() {
    ...
    try {
      if (_form_logo.currentState.validate()) {
        if(desKey_log.currentState.value==null||desKey_log.currentState.value==""||
...
//                                         content: new Text("يرجي الانتظار...سيتم التاكيد برساله"),
//                                       )
//                                       )
  restore() async {
