...
class Mobile_app extends StatefulWidget {

  @override
  _Mobile_appState createState() => new _Mobile_appState();
}


class _Mobile_appState extends State<Mobile_app> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: new Text(AppLocalizations.of(context).lblMobile_App,  style: MansaFont.baseFontStyle() ,) ,
          centerTitle: true,
                  ...
                  children: [
                    Row(
                        ...
                        children: <Widget>[
                          Container(
                            child: Text(
                              AppLocalizations.of(context).lblApp_Information,
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Expanded(
                                  flex: 1,
                                  child: Text(AppLocalizations.of(context).lblMobileAppName+" *", 
                                    //textAlign: TextAlign.center,
                                    ...
                                    children: <Widget>[
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: AppLocalizations.of(context).lblMobileAppName,
