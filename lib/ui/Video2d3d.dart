...
class Video2d3d extends StatefulWidget {

  @override
  _Video2d3dState createState() => new _Video2d3dState();
}


class _Video2d3dState extends State<Video2d3d> {
    ...
    return Scaffold(
        key: _scaffoldKey,
          ...
          appBar: AppBar(
            ...
            title: new Text(AppLocalizations.of(context).lblVideo_2D_3D,  style: MansaFont.baseFontStyle() ,) ,
            centerTitle: true,
                ...
                Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          Container(
                            child: Text(
                              AppLocalizations.of(context).lblVideo_Information,
                ...
                Row(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                            ...
                            child: Container(
                            child: Image.asset(
                               AppLocalizations.of(context).locale=="en" ?'images/uploadSctiptAr.PNG':'images/uploadSctiptAr.PNG',
                              height: 30,
                              width: 200,
                              fit: BoxFit.fill,
                              alignment: Alignment.center,
      ...
      //  emailKey_log.currentState.value==null||emailKey_log.currentState.value==""
        ...
        // youtubeKey_log.currentState.value==null||youtubeKey_log.currentState.value==""
          ...
          if (response.code ==200 ) {
            ...
            showInSnackBarAfterAddService(AppLocalizations.of(context).lblServiceAdded, _context, _scaffoldKey);
