...
class CreatePayment extends StatefulWidget {
  @override
  _CreatePaymentState createState() => new _CreatePaymentState();
}
...
void openFileExplorer() async {
    try {
     ...
     var value = await FilePicker.platform.pickFiles(
            type: _pickType , allowedExtensions: [_extension] , allowMultiple: false);
...
void getImageFromCamera() async{
  ...
  void getImageFromGallery() async {
    var imagefile = await ImagePicker().getImage(source: ImageSource.gallery,imageQuality: imageQuality);
